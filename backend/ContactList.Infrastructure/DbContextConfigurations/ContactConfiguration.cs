...
public class ContactConfiguration : IEntityTypeConfiguration<Contact>
{
    public void Configure(EntityTypeBuilder<Contact> builder)
    {
        builder.HasData(
            ...
            new Contact { Id = 3, FirstName = "John", LastName = "Smith", Email = "john.smith@gmail.com", Password = "Ex@mpleP@$$sowrd2", CategoryId = (int)Domain.Enums.ContactCategory.Work, SubCategoryId = (int)Domain.Enums.ContactSubCategory.Boss, PhoneNumber = "500-600-700" },
            new Contact { Id = 4, FirstName = "John", LastName = "Smith", Email = "john.smith@gmail.com", Password = "Ex@mpleP@$$sowrd3", CategoryId = (int)Domain.Enums.ContactCategory.Other, SubCategoryId = null, PhoneNumber = "555-666-777" }
            );
    }
}
